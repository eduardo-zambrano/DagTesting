...
| Prop 6.2 (SubDAG test validity) | `testStatistic_le_one_of_subDAG_markov` | **Proved** |
...
- `PowerAnalysis.lean`: MI-equivalence, power direction (Thm 6.1), SubDAG test validity (Prop 6.2)
